...
export const PROJECTS: ProjectDto[] = [
	{
		...
		attributes: {
			description:
				"Веб-приложение для подсчёта очков в настольной игре Munchkin, которая мне очень нравится. Все настройки и значения в приложении сохраняются в кэш браузера с использованием Zustand, а сам проект постоянно мигрирует на актуальные технологии",
	...
	},
	{
		...
		attributes: {
			description:
				"Лендинг для одного из продуктов компании GetShop.TV. Верстал по готовому дизайну, лендинг статически генерируется Next.js",
			title: "getads.ru",
